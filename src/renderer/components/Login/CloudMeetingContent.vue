    ...
    <div class="flex h-full flex-col">
      <div class="media-content w-1/3 self-end p-4 m-2 rounded-sm">
        <div class="flex justify-end">
          <a-iconfont type='setting' class="text-lg cursor-pointer text-white hover:text-blue"/>
        </div>
        <media-content/>
      </div>
        ...
        <div class="flex justify-center flex-col px-8 h-full pt-12">
          ...
          <div class="my-2">
            <a-input
                ...
                class="h-10"
            >
              <a-iconfont slot="prefix" type='team'/>
            </a-input>
          </div>
          <div class="my-2">
            <a-input
          ...
          <div class="flex flex-grow"></div>
          <div class="flex py-6">
            <a-iconfont class="text-white text-3xl cursor-pointer"
