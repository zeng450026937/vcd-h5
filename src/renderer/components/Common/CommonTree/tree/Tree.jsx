...
import { initDefaultProps, getOptionProps, filterEmpty } from 'ant-design-vue/es/_util/props-util';
...
export default {
  ...
  created() {
    if (!('treeNodes' in getOptionProps(this))) {
      console.warn('`treeNodes` is deprecated. please use treeData instead.');
    }
  },
  TreeNode,
  methods : {
