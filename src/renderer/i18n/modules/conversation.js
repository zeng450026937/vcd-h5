  ...
  lang : {
    zh : {
      ...
      tip : {
        ...
        unstableNetwork    : '当前网络状况不佳，建议切换为音频通话。',
        willHangup         : '对方长时间未接听，请稍后重试！',
        answerInConference : '接通来电将离开会议，请确认!',
    ...
    en : {
      ...
      share : {
        message : {
          sharingEnded : 'The sharing is terminate, cause by the closed application',
        },
      },
      statistics : {
        send              : 'send             ',
        ...
        closeDeviceInfo   : 'closeDeviceInfo  ',
        bitrate           : 'bitrate          ',
        ratio             : 'ratio            ',
        frameRate         : 'frameRate        ',
        codec             : 'codec            ',
        ...
        packetsLostRate   : 'packetsLostRate  ',
        video             : 'video            ',
        audio             : 'audio            ',
        screen            : 'screen           ',
        excellent         : 'excellent        ',
      ...
      controls : {
        ...
        raiseHangs          : 'Raise Hangs',
        cancelRaiseHangs    : 'Cancel Raise Hangs',
        screenShare         : 'Screen Share',
        more                : 'More',
        toAudio             : 'To Audio Conference',
        plate               : 'Dial Plate',
        exitConference      : 'Exit Conference',
        terminateOrLeave    : 'Would you want to terminate or just exit Conference?',
        terminateConference : 'Terminate Conference',
        cancel              : 'Cancel',
        ensureLeave         : 'Are you sure to exit conference?',
        justLeaveConference : 'The conference is continue when exit',
        leaveConference     : 'Exit Conference',
      },
    },
  },
};
