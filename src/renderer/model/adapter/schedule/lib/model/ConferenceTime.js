...
class ConferenceTime {
  ...
  constructor({startDateTime, endDateTime, zoneId, timeZoneConfig, recurrenceType, dailyType, recurrenceInterval, dayOfWeek, dayOfMonth, dayOfWeekIndex, monthOfYear, rangeStartDate, rangeEndDate, rangeType, rangeOccurrences, expectedStartTime, expectedEndTime} = {}) {
    ...
    /**
     * 周期会议的循环模式类型，0 = 按天循环，1 = 按周循环， 2 = 按月循环第一种模式，每几个月的第几天， 3 = 按月循环第二种模式，每几个月的第几个日子/工作日/周末，4 = 按年循环第一种模式，每年的第几月第几天，5 = 按年循环第二种模式，每年的第几月的第几个日子/工作日/周末
     */
    ...
    /**
     * 表示一周中的某天，存在多个时使用“,”分隔。例如：周一和周五表示为2,6。当type为按周循环（1）、按月循环第二种模式（3）和按年循环第二种模式（5）时，必须输入。可取值：-3 = 日子，-2 = 工作日，-1 = 周末，1 = 星期天，2 = 星期一，3 = 星期二，4 = 星期三，5 = 星期四，6 = 星期五，7 = 星期六。特别的当type = 1时，可选值为[1, 7]。
     */
