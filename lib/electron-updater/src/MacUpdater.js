...
import { safeStringifyJson } from './util-runtime/httpExecutor';
...
export class MacUpdater extends AppUpdater {
  ...
  doDownloadUpdate(downloadUpdateOptions) {
    ...
    const files = downloadUpdateOptions.updateInfoAndProvider.provider
      .resolveFiles(downloadUpdateOptions.updateInfoAndProvider.info);
    ...
    return this.executeDownload({
      ...
      task          : (destinationFile, downloadOptions) => this.httpExecutor.download(
        zipFileInfo.url, destinationFile, downloadOptions
      ),
      done : async event => {
