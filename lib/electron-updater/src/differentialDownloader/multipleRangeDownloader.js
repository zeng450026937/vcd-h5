import { createHttpError, safeGetHeader } from '../util-runtime/httpExecutor';
import { copyData, DataSplitter } from './DataSplitter';
import { OperationKind } from './downloadPlanBuilder';

export function executeTasksUsingMultipleRangeRequests(differentialDownloader, tasks, out, oldFileFd, reject) {
  const w = taskOffset => {
